...
readonly GNOME_PKGS="$BASE_PKGS gdm gnome polkit-gnome gnome-nibbles rhythmbox geary firefox chrome-gnome-shell gvfs-goa gvfs-mtp dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ufw tlp thermald chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf base-devel xtools git"
readonly KDE_PKGS="$BASE_PKGS kde5 kde5-baseapps ark spectacle sddm kdialog kwrite kdegraphics-thumbnailers plasma-browser-integration plasma-firewall gwenview okular dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ffmpegthumbs ufw tlp thermald base-devel xtools chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf firefox vlc"
readonly LXDE_PKGS="$BASE_PKGS lxde gvfs-mtp dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ufw tlp thermald base-devel xtools chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf firefox mpv"
