...
readonly XFCE_PKGS="$BASE_PKGS lightdm lightdm-gtk3-greeter lightdm-gtk-greeter-settings xfce4 xfce4-plugins gnome-themes-standard gnome-keyring numlockx network-manager-applet blueman scrot gvfs-mtp xdg-desktop-portal udisks2 transmission-gtk redshift firefox"
