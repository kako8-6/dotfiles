...
readonly GNOME_PKGS="gdm gnome gnome-terminal polkit-gnome dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ufw tlp thermald chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf liberation-fonts-ttf noto-fonts-ttf base-devel xtools git firefox firefox-i18n-es-MX"
readonly KDE_PKGS="kde5 kde5-baseapps ark spectacle sddm kdialog kwrite kdegraphics-thumbnailers plasma-browser-integration plasma-firewall gwenview okular dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi intel-video-accel xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ffmpegthumbs ufw tlp thermald base-devel xtools chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf firefox firefox-i18n-es-ES mpv"
readonly LXDE_PKGS="$BASE_PKGS lxde dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi intel-video-accel xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ffmpegthumbs ufw tlp thermald base-devel xtools chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf firefox firefox-i18n-es-ES mpv"
