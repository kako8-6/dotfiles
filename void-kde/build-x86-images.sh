...
readonly XFCE_PKGS="$BASE_PKGS lightdm lightdm-gtk3-greeter lightdm-gtk-greeter-settings xfce4 xfce4-plugins gnome-themes-standard gnome-keyring redshift-gtk network-manager-applet blueman scrot bluez gvfs-mtp udisks2 firefox"
