...
readonly GNOME_PKGS="$BASE_PKGS gdm gnome gnome-terminal polkit-gnome gnome-nibbles chrome-gnome-shell gvfs-goa gvfs-mtp dbus zramen brightnessctl nano flatpak xorg-minimal mesa-dri mesa-vulkan-intel mesa-vaapi xdg-user-dirs xdg-utils xdg-desktop-portal glxinfo bash-completion htop neofetch ffmpeg ufw tlp thermald chrony pulseaudio alsa-plugins-pulseaudio font-adobe-source-code-pro fonts-droid-ttf noto-fonts-emoji liberation-fonts-ttf dejavu-fonts-ttf noto-fonts-ttf base-devel xtools git firefox"
