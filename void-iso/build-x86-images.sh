...
readonly XFCE_PKGS="$BASE_PKGS lightdm lightdm-gtk3-greeter lightdm-gtk-greeter-settings xfce4 xfce4-plugins thunar-archive-plugin gnome-themes-standard gnome-keyring numlockx network-manager-applet blueman scrot gvfs-mtp papirus-icon-theme xarchiver xdg-desktop-portal-gtk udisks2 redshift firefox"
